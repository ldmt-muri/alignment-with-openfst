...
# USING mpi + boost
	mpiCC -x c++ anneal/Cpp/erstream.hpp anneal/Cpp/erstream.cxx anneal/Cpp/randgen.hpp anneal/Cpp/rndlcg.hpp anneal/Cpp/rndlcg.cxx anneal/Cpp/registrar.hpp anneal/Cpp/registrar.cxx anneal/Cpp/randgen.cxx anneal/Cpp/r250.hpp anneal/Cpp/r250.cxx anneal/Cpp/random.hpp anneal/Cpp/random.cxx anneal/Cpp/simann.hpp anneal/Cpp/simann.cxx cdec-utils/fast_sparse_vector.h cdec-utils/fdict.h cdec-utils/fdict.cc Samplers.h StringUtils.h VocabEncoder.h MultinomialParams.h MultinomialParams.cc LearningInfo.h FstUtils.h FstUtils.cc LogLinearParams.h LogLinearParams.cc LatentCrfModel.h LatentCrfModel.cc train-latentCrfModel.cc -llbfgs -lfst -ldl -lboost_mpi -lboost_serialization -lboost_thread -lboost_system -O3 -I/usr/include/x86_64-linux-gnu/c++/4.7/ -g -ggdb -o train-latentCrfModel
