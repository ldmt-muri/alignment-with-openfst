...
#	echo #autoencoders
	clang++ -x c++ alias_sampler.h MultinomialParams.h MultinomialParams.cc LearningInfo.h StringUtils.h VocabEncoder.h FstUtils.h FstUtils.cc LogLinearParams.h LogLinearParams.cc AutoEncoder.h AutoEncoder.cc train-autoencoder.cc -llbfgs -lfst -ldl -O0 -I/usr/include/x86_64-linux-gnu/c++/4.7/ -o train-autoencoder
