...
mpirun -np $2 ./train-latentCrfAligner     example/100.fr-en     none     none  talign/grammars/wordpair-features  example/run.latent-crf-aligner.fr-en.$1 2> example/run.latent-crf-aligner.fr-en.$1.err 
