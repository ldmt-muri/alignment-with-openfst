...
mpirun -np $2 ./train-latentCrfAligner     example/tiny.fr-en     none     none  talign/grammars/wordpair-features  example/run.latent-crf-aligner.fr-en.$1 2> example/run.latent-crf-aligner.fr-en.$1.err 
...
#example/run.latent-crf-aligner.fr-en.10k-17.11.lambda \
#example/run.latent-crf-aligner.fr-en.10k-17.11.theta \