...
mpirun -np $2 ./train-latentCrfAligner     \
    ...
    2> example/run.latent-crf-aligner.fr-en.$1.err 
...
#example/run.latent-crf-aligner.fr-en.1k.initial.lambda
#example/run.latent-crf-aligner.fr-en.1k.initial.theta
